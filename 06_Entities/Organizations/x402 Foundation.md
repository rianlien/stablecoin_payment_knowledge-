...
x402 Foundation は、Linux Foundation 傘下で [[x402]] プロトコルの標準化・ガバナンスを担う組織。会社・事業主体としての Coinbase は [[Coinbase]]、プロトコル仕様は [[x402]]、エコシステム全体の俯瞰は [[x402-ecosystem]] を参照。
...
x402 Foundation は企業ではなく、標準化・ガバナンス組織として扱うべき対象。Coinbase の戦略ページに吸収すると「誰が事業を持つのか」と「誰が標準を管理するのか」が混ざるため、Organizations 配下に分けておく。
