...
| 2026-06-16 | [[2026-06-16_Zip-Stripe_shared-payment-tokens-agentic]] | Zip US が SPT 経由で BNPL を MPP エコシステムに追加——支払い手段の多様化 |
...
- [[Tempo]] — MPP を実装するブロックチェーンインフラ（Stripe・Paradigm 支援）
- [[psp-merchant-readiness]] — PSP・マーチャントのエージェント決済対応状況
